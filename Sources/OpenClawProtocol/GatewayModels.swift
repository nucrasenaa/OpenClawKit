// Generated by Scripts/protocol-gen-swift.mjs — do not edit by hand
import Foundation

/// Latest supported gateway protocol version.
...
/// Connection handshake parameters exchanged with gateway peers.
public struct ConnectParams: Codable, Sendable {
    ...
    /// Creates connection handshake parameters.
    public init(
        minProtocol: Int,
        maxProtocol: Int,
...
/// Error payload embedded in response frames.
public struct ErrorShape: Codable, Sendable {
    public let code: ErrorCode
    public let message: String

    /// Creates an error shape payload.
    public init(
        code: ErrorCode,
        message: String
    ) {
...
/// Tagged sum type for gateway wire frames.
public enum GatewayFrame: Codable, Sendable {
    ...
    /// Decodes a tagged gateway frame.
    ...
    /// Encodes a tagged gateway frame.
